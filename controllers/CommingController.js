angular.module('AppFilm').controller('CommingController', function($rootScope, $scope, $http, $location, $log, Film, BuildUrl, CallApi, reverseFilter) {
    ...
    CallApi.callRestApiGet("movie/upcoming").then(function(data) {
